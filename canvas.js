...
drawText = () => {
    ...
    ctx.fillText(`Question 1`, 50, 10);
    //question 2
    ctx.fillText('Answer 1', 150 , 150);
    ctx.fillText('Answer 2', 200, 150);
    ctx.fillText('Answer 3', 250, 150);
    ctx.fillText(`Question 2`, 200, 10);
    //question3
    ctx.fillText('Answer 1', 300 , 150);
    ctx.fillText('Answer 2', 350, 150);
    ctx.fillText('Answer 3', 400, 150);
    ctx.fillText(`Question 3`, 350, 10);
}
...
drawGraph(10,25,50,50,25,25,50,100,50);
drawText();